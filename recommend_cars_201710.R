...
history_car = read.csv("D:/big_data_exchange/xxxx_output/history/car_list.csv", 
...
filename = file(paste0("D:/big_data_exchange/xxxx_output/history/", "car_list.csv"), encoding="UTF-8")
write.csv(car_result, filename, row.names = FALSE)
######################讀取歷史拍賣資料並將最新一筆拍賣結果資料併入歷史拍賣資料#########################
history_result = read.csv("D:/big_data_exchange/xxxx_output/history/result_list.csv", 
                       sep = ",",fileEncoding = "utf-8")
...
filename = file(paste0("D:/big_data_exchange/xxxx_output/history/", "result_list.csv"), encoding="UTF-8")
write.csv(result_result, filename, row.names = FALSE)
#read history bid
history_bid = read.csv("D:/big_data_exchange/xxxx_output/history/bid_list.csv", 
                       sep = ",",fileEncoding = "utf-8")
...
filename = file(paste0("D:/big_data_exchange/xxxx_output/history/", "bid_list.csv"), encoding="UTF-8")
...
filename = file(paste0("D:/big_data_exchange/xxxx_output/list/", last_day,"_list.csv"), encoding="UTF-8")
